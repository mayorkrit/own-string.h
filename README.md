...
Реализация библиотеки string.h с дополнениями в рамках проекта `Школы 21`
...
3. [Chapter III](#chapter-iii) \
    3.1. [Part 1](#1-реализация-функций-библиотеки-stringh)  
    3.2. [Part 2](#2-частичная-реализация-функции-sprintf)  
    3.5. [Part 3](#3-реализация-специальных-функций-обработки-строк)  
...
Реалиизация описанных [выше](#stringh-функции) функциий библиотеки string.h: 

Полное покрытие unit-тестами
отчёт gcov в виде html страницы.
...
## 3. Реализация специальных функций обработки строк
