...
// 6
START_TEST(strcat_test_add_to_empty) {
#line 103
char dest[10] = "";
char src[5] = "123";
...
START_TEST(strcat_test_add_empty) {
#line 109
char dest[10] = "123";
char src[5] = "";
ck_assert_str_eq(strcat(dest, src), s21_strcat(dest, src));
...
START_TEST(strcat_test_add_empty_to_empty) {
#line 115
char dest[10] = "";
char src[5] = "";
ck_assert_str_eq(strcat(dest, src), s21_strcat(dest, src));
...
Suite *suite_strcat(void) {
    ...
    tcase_add_test(tc1_1, strcat_test_add_to_empty);
    tcase_add_test(tc1_1, strcat_test_add_empty);
    tcase_add_test(tc1_1, strcat_test_add_empty_to_empty);
