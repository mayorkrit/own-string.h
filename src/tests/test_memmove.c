...
Suite *suite_memmove(void) {
    ...
    tcase_add_test(tc1_1, memmove_test_1);
    tcase_add_test(tc1_1, memmove_test_2);
    tcase_add_test(tc1_1, memmove_test_3);
    tcase_add_test(tc1_1, memmove_test_4);
    tcase_add_test(tc1_1, memmove_test_5);
