...
START_TEST(strspn_middle_match) {
#line 375
char s1[] = "123fef21";
char s2[] = "fef";
ck_assert_pstr_eq(strstr(s1, s2), s21_strstr(s1, s2));
...
Suite *suite_strspn(void) {
    ...
    tcase_add_test(tc1_1, strspn_default);
    tcase_add_test(tc1_1, strspn_s1_empty);
    tcase_add_test(tc1_1, strspn_s2_empty);
    tcase_add_test(tc1_1, strspn_both_empty);
    tcase_add_test(tc1_1, strspn_no_match);
    tcase_add_test(tc1_1, strspn_middle_match);
