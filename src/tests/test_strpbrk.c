...
Suite *suite_strpbrk(void) {
    ...
    tcase_add_test(tc1_1, strpbrk_default);
    tcase_add_test(tc1_1, strpbrk_s2_empty);
    tcase_add_test(tc1_1, strpbrk_no_match);
    tcase_add_test(tc1_1, strpbrk_no_s1);
    tcase_add_test(tc1_1, strpbrk_both_empty);
    tcase_add_test(tc1_1, strpbrk_last_match);
