...
Suite *suite_strrchr(void) {
    ...
    tcase_add_test(tc1_1, strrchr_default);
    tcase_add_test(tc1_1, strrchr_no_match);
    tcase_add_test(tc1_1, strrchr_empty_str);
    tcase_add_test(tc1_1, strrchr_last_match);
