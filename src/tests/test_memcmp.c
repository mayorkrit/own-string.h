...
// 2
START_TEST(memcmp_test_2_test1) {
#line 20
...
START_TEST(memcmp_test_2_empty) {
#line 25
unsigned char s1[15] = "";
...
START_TEST(memcmp_test_2_secondEmpty) {
#line 30
...
START_TEST(memcmp_test_2_negativeNumber) {
#line 35
unsigned char s1[15] = "abcd";
...
Suite *suite_memcmp(void) {
    ...
    tcase_add_test(tc1_1, memcmp_test_2_test1);
    tcase_add_test(tc1_1, memcmp_test_2_empty);
    tcase_add_test(tc1_1, memcmp_test_2_secondEmpty);
    tcase_add_test(tc1_1, memcmp_test_2_negativeNumber);
    return s1;
}
