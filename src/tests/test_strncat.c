...
Suite *suite_strncat(void) {
    ...
    tcase_add_test(tc1_1, strncat_test_base);
    tcase_add_test(tc1_1, strncat_test_zero);
    tcase_add_test(tc1_1, strncat_test_over);
