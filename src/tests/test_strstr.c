...
// 20
// #test strtok_1
// char s1[] = "Особенности национальной рыбалки - художественный, комедийный фильм.";
// char s2[] = " ,.-";
// char s11[] = "Особенности национальной рыбалки - художественный, комедийный фильм.";
// char s22[] = " ,.-";
// ck_assert_pstr_eq(strtok(s1, s2), s21_strtok(s11, s22));

// #test strtok_2
// char s1[] = "BLA BLA BLA BLA BLA BLA BLAAAAAAAAAAAAAAA)";
// char s2[] = ")";
// char s11[] = "BLA BLA BLA BLA BLA BLA BLAAAAAAAAAAAAAAA)";
// char s22[] = ")";
// ck_assert_pstr_eq(strtok(s1, s2), s21_strtok(s11, s22));

// #test strtok_3
// char s1[] = "HEHEHEHEHEHEHEHEHEEHEHEHE";
// char s2[] = "*&^@@#";
// char s11[] = "HEHEHEHEHEHEHEHEHEEHEHEHE";
// char s22[] = "*&^@@#";
// ck_assert_pstr_eq(strtok(s1, s2), s21_strtok(s11, s22));
}
END_TEST
...
Suite *suite_strstr(void) {
    ...
    tcase_add_test(tc1_1, strstr_default);
    tcase_add_test(tc1_1, strstr_last_match);
    tcase_add_test(tc1_1, strstr_no_match);
    tcase_add_test(tc1_1, strstr_s1_empty);
    tcase_add_test(tc1_1, strstr_s2_empty);
    tcase_add_test(tc1_1, strstr_boh_empty);
    return s1;
}
