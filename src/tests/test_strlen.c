...
START_TEST(len_test_whitespaces) {
#line 289
char s1[] = "                      ";
ck_assert_uint_eq(strlen(s1), s21_strlen(s1));
}
...
START_TEST(len_test_single_char) {
#line 293
char s1[] = "2";
ck_assert_uint_eq(strlen(s1), s21_strlen(s1));
...
Suite *suite_strlen(void) {
    ...
    tcase_add_test(tc1_1, len_test_1);
    tcase_add_test(tc1_1, len_test_empty);
    tcase_add_test(tc1_1, len_test_2);
    tcase_add_test(tc1_1, len_test_emptyyy);
    tcase_add_test(tc1_1, len_test_whitespaces);
    tcase_add_test(tc1_1, len_test_single_char);
    return s1;
}
